...
/*
 frutas.every((fruta, index) => {
     console.log(fruta=='sandia' && index==0)
 })
*/
...
/*
let encontrado = frutas.includes('Banana'.toLowerCase())
...
//JOIN:Nos une los elementos del array según 
//le indiquemos 
...
frutas.splice(4,1)// Elimina un elemento
 console.log(frutas)  
*/
